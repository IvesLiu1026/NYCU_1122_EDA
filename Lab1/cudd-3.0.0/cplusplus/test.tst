...
{ rank = same; "CONST NODES";
{ node [shape = box]; "0x209";
}
}
"  s0  " -> "0x286" [style = solid];
"  s1  " -> "0x288" [style = solid];
"  s2  " -> "0x28a" [style = solid];
"  c3  " -> "0x28b" [style = solid];
"0x28a" -> "0x289";
"0x28a" -> "0x289" [style = dotted];
"0x28b" -> "0x210";
"0x28b" -> "0x289" [style = dashed];
"0x210" -> "0x209";
"0x210" -> "0x209" [style = dotted];
"0x288" -> "0x287";
"0x288" -> "0x287" [style = dotted];
"0x289" -> "0x242";
"0x289" -> "0x287" [style = dashed];
"0x242" -> "0x209";
"0x242" -> "0x209" [style = dotted];
"0x287" -> "0x261";
"0x287" -> "0x285" [style = dashed];
"0x286" -> "0x285";
"0x286" -> "0x285" [style = dotted];
"0x261" -> "0x209";
"0x261" -> "0x209" [style = dotted];
"0x285" -> "0x209";
"0x285" -> "0x209" [style = dotted];
"0x209" [label = "1"];
}
